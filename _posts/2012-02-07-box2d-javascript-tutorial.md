...
{% endhighlight %}First one thing: `requestAnimFrame()` is simply a helper function that makes animation smarter. [Read more about it here](http://paulirish.com/2011/requestanimationframe-for-smart-animating/).
